...
export const defaultAriaLiveMessages = {
  ...
  guidance: (props: AriaGuidanceProps) => {
    ...
    switch (context) {
      ...
      // live message for selected values
      case "value":
