...
// prop definition of dropdown indicator
...
> extends CommonPropsAndClassName<Option, IsMulti, Group> {
  ...
  isFocused: boolean;
  // if Dropdown Indicator is disabled
  isDisabled: boolean;
}
...
// prop definiton of clear indicator
...
> extends CommonPropsAndClassName<Option, IsMulti, Group> {
  ...
  /** The focused state of the select. */
  isFocused: boolean;
  // No isDisabled here like DropdownIndicatorProps, because ClearIndicator would always be clickable
}
...
// indicator separator: see https://react-select.com/components#replaceable-components
...
// generate indicator separator css based on params
