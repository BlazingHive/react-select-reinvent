...
// input props
// note that it is possible to extends two(or more) interfaces
...
// seems no need to define InputSpecificProps and then assign to InputProps
...
// generate input css based on params
