...
// calculate its placement and maxHeight
export function getMenuPlacement({
  ...
  // get scroll parent (nearest parent scrollable)
...
// menu props: extends common props and menu placement props
...
> extends CommonPropsAndClassName<Option, IsMulti, Group>,
  ...
  // children of menu: all the options
  children: ReactNode;
}
...
// menu placer props
// placer is a wrapper component that wraps menu and equiped with
// placement settings
...
// context contains setPortalPlacement set state func
const PortalPlacementContext = createContext<{
  setPortalPlacement: (placement: CoercedMenuPlacement) => void;
} | null>(null);

// NOTE: internal only
// the placer middle component (parent: menu portal)
// that delivers its children (menu component) with placement settings
...
// generate menu list css based on params
...
// generate notice css (no options message notice or loading message notice) bases on params
const noticeCSS = <
  Option,
  IsMulti extends boolean,
  Group extends GroupBase<Option>
...
// define default props for message component
...
// define default props for children
...
// generate menu portal css based on params
...
// exported menu portal component
// portal is the outmost wrapper component that wraps menu placer
